...
sub hlx_log_deliver_json {
  log {"syslog 3l2MjGcHgWw5NUJz7OKYH3 Azure Test :: "} "{" 
    ...
    + "%22client_geo_city%22: %22" + json.escape(client.geo.city) + "%22, "
    ...
    + "%22req_http_Accept-Charset%22: %22" + json.escape(req.http.Accept-Charset) + "%22, "
    + "%22req_http_Accept-Encoding%22: %22" + json.escape(req.http.Accept-Encoding) + "%22, "
    + "%22req_http_Accept-Encoding%22: %22" + json.escape(req.http.Accept-Encoding) + "%22, "
    + "%22req_http_Accept-Encoding%22: %22" + json.escape(req.http.Accept-Encoding) + "%22, "
    + "%22req_http_Accept-Language%22: %22" + json.escape(req.http.Accept-Language) + "%22, "
    + "%22req_http_Accept%22: %22" + json.escape(req.http.Accept) + "%22, "
    + "%22req_http_Fastly-FF%22: %22" + json.escape(req.http.Fastly-FF) + "%22, "
    + "%22req_http_Fastly-SSL%22: %22" + json.escape(req.http.Fastly-SSL) + "%22, "
    + "%22req_http_host%22: %22" + json.escape(req.http.host) + "%22, "
    + "%22req_http_Referer%22: %22" + json.escape(req.http.Referer) + "%22, "
    + "%22req_http_User-Agent%22: %22" + json.escape(req.http.User-Agent) + "%22, "
    + "%22req_http_Viewport-Width%22: %22" + json.escape(req.http.Viewport-Width) + "%22, "
    + "%22req_http_X-Action-Root%22: %22" + json.escape(req.http.X-Action-Root) + "%22, "
    + "%22req_http_X-Allow%22: %22" + json.escape(req.http.X-Allow) + "%22, "
    + "%22req_http_X-Backend-Name%22: %22" + json.escape(req.http.X-Backend-Name) + "%22, "
    + "%22req_http_X-CDN-Request-ID%22: %22" + json.escape(req.http.X-CDN-Request-ID) + "%22, "
    + "%22req_http_X-Debug%22: %22" + json.escape(req.http.X-Debug) + "%22, "
    + "%22req_http_X-Deny%22: %22" + json.escape(req.http.X-Deny) + "%22, "
    + "%22req_http_X-Dirname%22: %22" + json.escape(req.http.X-Dirname) + "%22, "
    + "%22req_http_X-Embed%22: %22" + json.escape(req.http.X-Embed) + "%22, "
    + "%22req_http_X-Encoded-Params%22: %22" + json.escape(req.http.X-Encoded-Params) + "%22, "
    + "%22req_http_X-ESI%22: %22" + json.escape(req.http.X-ESI) + "%22, "
    + "%22req_http_X-GitHub-Static-Owner%22: %22" + json.escape(req.http.X-GitHub-Static-Owner) + "%22, "
    + "%22req_http_X-GitHub-Static-Ref%22: %22" + json.escape(req.http.X-GitHub-Static-Ref) + "%22, "
    + "%22req_http_X-GitHub-Static-Repo%22: %22" + json.escape(req.http.X-GitHub-Static-Repo) + "%22, "
    + "%22req_http_X-Host%22: %22" + json.escape(req.http.X-Host) + "%22, "
    + "%22req_http_X-Index%22: %22" + json.escape(req.http.X-Index) + "%22, "
    + "%22req_http_X-Orig-host%22: %22" + json.escape(req.http.X-Orig-host) + "%22, "
    + "%22req_http_X-Orig-URL%22: %22" + json.escape(req.http.X-Orig-URL) + "%22, "
    + "%22req_http_X-Owner%22: %22" + json.escape(req.http.X-Owner) + "%22, "
    + "%22req_http_X-Ref%22: %22" + json.escape(req.http.X-Ref) + "%22, "
    + "%22req_http_X-Repo%22: %22" + json.escape(req.http.X-Repo) + "%22, "
    + "%22req_http_X-Static%22: %22" + json.escape(req.http.X-Static) + "%22, "
    + "%22req_http_X-Strain%22: %22" + json.escape(req.http.X-Strain) + "%22, "
    + "%22req_http_X-Trace%22: %22" + json.escape(req.http.X-Trace) + "%22, "
    + "%22req_http_X-URL%22: %22" + json.escape(req.http.X-URL) + "%22, "
    + "%22req_request%22: %22" + json.escape(req.request) + "%22, "
    ...
    + "%22resp_http_Content-Type%22: %22" + json.escape(resp.http.Content-Type) + "%22, "
    + "%22resp_http_Via%22: %22" + json.escape(resp.http.Via) + "%22, "
    + "%22resp_http_X-Cache-Hits%22: %22" + json.escape(resp.http.X-Cache-Hits) + "%22, "
    + "%22resp_http_X-Cache%22: %22" + json.escape(resp.http.X-Cache) + "%22, "
    + "%22resp_http_X-Content-Type%22: %22" + json.escape(resp.http.X-Content-Type) + "%22, "
    + "%22resp_http_X-Fastly-Request-Id%22: %22" + json.escape(resp.http.X-Fastly-Request-Id) + "%22, "
    + "%22resp_http_X-GitHub-Request-Id%22: %22" + json.escape(resp.http.X-GitHub-Request-Id) + "%22, "
    + "%22resp_http_X-GW-Cache%22: %22" + json.escape(resp.http.X-GW-Cache) + "%22, "
    + "%22resp_http_X-host%22: %22" + json.escape(resp.http.X-host) + "%22, "
    + "%22resp_http_x-openwhisk-activation-id%22: %22" + json.escape(resp.http.x-openwhisk-activation-id) + "%22, "
    + "%22resp_http_X-Request-Id%22: %22" + json.escape(resp.http.X-Request-Id) + "%22, "
    + "%22resp_http_X-Version%22: %22" + json.escape(resp.http.X-Version) + "%22, "
    + "%22resp_status%22: %22" + json.escape(resp.status) + "%22, "
